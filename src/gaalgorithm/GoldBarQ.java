...
public class GoldBarQ {
	...
	public static void main(String[] args) {
		...
		System.out.println("best sum : " + gc.best_chr.sum + " best value : " + gc.best_chr.val);
	...
	static class GAController{
		...
		public void test() {
			...
			//best chromosome 이 MAX_UNCHANGED 세대 이상 변화가 없다면 알고리즘을 끝내라.
		...
		private void crossover() {
			...
			combination(population, visited, 0, (int) (population_size*select_ratio), 2);
